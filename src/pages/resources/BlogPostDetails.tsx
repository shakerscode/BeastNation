...
const BlogPostDetails = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r pt-16 lg:pt-32 from-black via-gray-900 to-black text-white">
      <div className="max-w-7xl 2xl:max-w-[1536px] mx-auto px-4 md:px-10 grid md:grid-cols-2 gap-10">
        <div className="pt-10">
