...
const features = [
  {
    ...
    description: "Advanced AI monitoring to protect your brand reputation online."
  },
  {
    icon: <ChartBar className="h-6 w-6" />,
    title: "Analytics Dashboard",
    description: "Real-time data visualization of campaign performance and ROI."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Creator Matching",
    description: "AI-powered algorithm to find perfect creator matches for your brand."
  },
  {
    icon: <Cloud className="h-6 w-6" />,
    title: "Cloud Integration",
    description: "Seamless integration with your existing marketing tools and platforms."
  }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold font-display mb-6">
              Reputation Management <span className="text-gradient">Reimagined</span>
            </h2>
            
            <p className="text-white/70 mb-8">
              Our AI-powered reputation management platform monitors, analyzes, and protects your brand across the digital landscape, ensuring consistent positive presence.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 right-20 glass px-3 py-1 rounded-full border border-white/20 text-sm animate-float shadow-glow z-30 hidden md:block" style={{animationDelay: '1s'}}>
              <div className="flex items-center">
